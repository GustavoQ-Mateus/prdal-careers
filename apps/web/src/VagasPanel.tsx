    ...
    <div className="stack">
      <section className="panel">
        <div className="panel-head">
          <h2>Nova vaga</h2>
          <span className="label">Extração automática de keywords</span>
        </div>
        <form onSubmit={criar} className="panel-body form-grid">
          <p className="section-intro">
            Cole a descrição original para gerar uma versão de currículo alinhada à oportunidade.
          </p>
          ...
          <div>
            <button type="submit" className="accent">Cadastrar e extrair keywords</button>
          </div>
        </form>
      </section>
      ...
      <section className="panel">
        ...
        {aviso && <div className="panel-body feedback" role="status">{aviso}</div>}
        {vagas.length === 0 ? (
                    ...
                    <td>
                      <div className="row">
                        ...
                        <button onClick={() => acompanhar(vaga)} disabled={acompanhandoId === vaga.id}>
                          {acompanhandoId === vaga.id ? 'Adicionando...' : 'Acompanhar'}
                        </button>
                      </div>
                    </td>
                  </tr>
